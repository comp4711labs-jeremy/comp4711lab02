...
class Quotes extends CI_Model
{
	...
	var $data = array(
		...
		'7'	 => array('who'	 => 'Martin Luther King Jr', 'role'	 => 'Activist',
			'what'	 => 'Darkness cannot drive out the darkness: only light can do that. Hate cannot drive hate: only love can do that.')
	);
